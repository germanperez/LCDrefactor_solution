...
/**
 * Class that contains the constants.
 * 
 * @author German Perez
 */
public class Constants {
	
	/** Constant VERTICAL CHARACTER */
	public static final String VERTICAL_CHARACTER = "|";
	
	/** Constant HORIZONTAL CHARACTER */
    public static final String HORIZONTAL_CHARACTER = "-";
    ...
    /** Constant FINAL CHAIN */
    public static final String FINAL_CHAIN = "0,0";
    
    /** Constant VERTICAL CHARACTER */
	public static final String COMMA_CHARACTER = ",";
	
	/** Constant TOTAL PARAMETERS */
	public static final Integer TOTAL_PARAMETERS = 2;
	
	/** Constant MINIMUM SIZE */
	public static final Integer MINIMUM_SIZE = 1;
